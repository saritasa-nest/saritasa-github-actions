...
- Preserves human-written text in the PR description
...
## Adding Your Own Comments to the PR Description

The AI-generated summary is placed at the top of the PR description and ends with a `**generated by ...**` line. Any text you write **below** that line will be preserved and never overwritten by the AI.
...
Task: [SD-123](https://saritasa.atlassian.net/browse/SD-123)

- AI-generated bullet point

**generated by gpt-5**

Your custom notes here — this text will not be touched on subsequent runs.
```

> **Note:** If you write your description **before** opening the PR (in the PR creation form), that text will also be preserved — it will appear below the AI-generated block after the first run.
