...
def convert_vulns_results_to_json(run: Dict[str, any]) -> Dict[str, any]:
    """
    ...
    for item in run['results']:
        ...
        rule_info = vulns_info.get(item['ruleId'], {})
...
def main():
    ...
    parser.add_argument('check_type', type=str, choices=['vulns'], help='Check type (vulns)')
    ...
    if args.check_type == 'vulns':
        result = convert_vulns_results_to_json(run) 
